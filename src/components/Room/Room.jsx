        ...
        {roomDataContainer.map((room) => (
          ...
          >
            ...
            <div className="flex justify-between p-2">
              ...
              <p className="border border-rose-400 w-24 h-10 flex justify-center items-center text-rose-400 cursor-pointer">
                {/* Clicking on the rate will navigate to the details of that room */}
                <Link to={`/room/${room.id}`}>{room.rate}</Link>
              </p>
            </div>
